import { ActivityHandler, TurnContext, MemoryStorage } from 'botbuilder';
import * as teams from 'botbuilder-teams';

const storage = new MemoryStorage();

export class MrRobot extends ActivityHandler {
    constructor() {
        super();
...
async function logMessageText(storage: MemoryStorage, turnContext: TurnContext) {
